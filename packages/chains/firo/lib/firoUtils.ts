...
import { FIRO_TX_BASE_SIZE } from './constants';
import { FIRO_INPUT_SIZE } from './constants';
import { FIRO_OUTPUT_SIZE } from './constants';
...
export const estimateTxFee = (
  ...
  const txSize =
    FIRO_TX_BASE_SIZE +
    inputSize * FIRO_INPUT_SIZE +
    outputSize * FIRO_OUTPUT_SIZE;
