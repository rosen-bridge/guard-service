...
```
/packages/abstract-chain    → General logic and requirements for supporting blockchains
/packages/chains            → Chain-specific implementations for each supported blockchain
/packages/networks          → Network API providers for each supported chain
/services                   → Guard service implementation
```
...
[MIT](./LICENSE) License © 2025-Present Rosen Bridge
