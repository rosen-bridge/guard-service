...
describe("CardanoChain", () => {
    ...
    describe("verifyTransactionWithEvent", () => {
        ...
        it("should accept a valid payment tx", async () => {
            // mock asset payment event
            const mockedEvent: EventTrigger = TestBoxes.mockAssetPaymentEventTrigger()
            const tx = TestBoxes.mockValidPaymentTransaction(mockedEvent, testBankAddress)
        ...
        it("should reject an invalid payment tx containing metadata", async () => {
            // mock asset payment event
            const mockedEvent: EventTrigger = TestBoxes.mockAssetPaymentEventTrigger()
            const tx = TestBoxes.mockPaymentTransactionWithMetadata(mockedEvent, testBankAddress)
