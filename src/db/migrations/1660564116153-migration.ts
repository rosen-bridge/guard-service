...
export class migration1660564116153 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "confirmed_event_entity" ("id" varchar PRIMARY KEY NOT NULL, "status" varchar NOT NULL, "eventDataId" integer, CONSTRAINT "REL_fada7feaf4c23ad7c0c2cf58ff" UNIQUE ("eventDataId"))`);
        await queryRunner.query(`CREATE TABLE "transaction_entity" ("txId" varchar PRIMARY KEY NOT NULL, "txJson" varchar NOT NULL, "type" varchar NOT NULL, "chain" varchar NOT NULL, "status" varchar NOT NULL, "lastCheck" integer NOT NULL, "eventId" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_confirmed_event_entity" ("id" varchar PRIMARY KEY NOT NULL, "status" varchar NOT NULL, "eventDataId" integer, CONSTRAINT "REL_fada7feaf4c23ad7c0c2cf58ff" UNIQUE ("eventDataId"), CONSTRAINT "FK_fada7feaf4c23ad7c0c2cf58ffd" FOREIGN KEY ("eventDataId") REFERENCES "event_trigger_entity" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_confirmed_event_entity"("id", "status", "eventDataId") SELECT "id", "status", "eventDataId" FROM "confirmed_event_entity"`);
        await queryRunner.query(`DROP TABLE "confirmed_event_entity"`);
        await queryRunner.query(`ALTER TABLE "temporary_confirmed_event_entity" RENAME TO "confirmed_event_entity"`);
        await queryRunner.query(`CREATE TABLE "temporary_transaction_entity" ("txId" varchar PRIMARY KEY NOT NULL, "txJson" varchar NOT NULL, "type" varchar NOT NULL, "chain" varchar NOT NULL, "status" varchar NOT NULL, "lastCheck" integer NOT NULL, "eventId" varchar, CONSTRAINT "FK_392573e185afb94149a20cf87df" FOREIGN KEY ("eventId") REFERENCES "confirmed_event_entity" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_transaction_entity"("txId", "txJson", "type", "chain", "status", "lastCheck", "eventId") SELECT "txId", "txJson", "type", "chain", "status", "lastCheck", "eventId" FROM "transaction_entity"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction_entity" ("txId" varchar PRIMARY KEY NOT NULL, "txJson" varchar NOT NULL, "type" varchar NOT NULL, "chain" varchar NOT NULL, "status" varchar NOT NULL, "lastCheck" integer NOT NULL, "eventId" varchar)`);
        await queryRunner.query(`INSERT INTO "transaction_entity"("txId", "txJson", "type", "chain", "status", "lastCheck", "eventId") SELECT "txId", "txJson", "type", "chain", "status", "lastCheck", "eventId" FROM "temporary_transaction_entity"`);
        await queryRunner.query(`DROP TABLE "temporary_transaction_entity"`);
        await queryRunner.query(`ALTER TABLE "confirmed_event_entity" RENAME TO "temporary_confirmed_event_entity"`);
        await queryRunner.query(`CREATE TABLE "confirmed_event_entity" ("id" varchar PRIMARY KEY NOT NULL, "status" varchar NOT NULL, "eventDataId" integer, CONSTRAINT "REL_fada7feaf4c23ad7c0c2cf58ff" UNIQUE ("eventDataId"))`);
        await queryRunner.query(`INSERT INTO "confirmed_event_entity"("id", "status", "eventDataId") SELECT "id", "status", "eventDataId" FROM "temporary_confirmed_event_entity"`);
        await queryRunner.query(`DROP TABLE "temporary_confirmed_event_entity"`);
